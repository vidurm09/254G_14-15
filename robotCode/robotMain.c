...
#pragma config(Sensor, in2,    rigthLift,      sensorPotentiometer)
...
#pragma config(Sensor, dgtl9,  bottom,         sensorTouch)
#pragma config(Sensor, dgtl10, top,            sensorTouch)
#pragma config(Sensor, dgtl11, dumpTray,       sensorDigitalOut)
